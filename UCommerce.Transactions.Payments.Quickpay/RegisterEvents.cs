...
namespace UCommerce.Transactions.Payments.Unzer
{
    public class RegisterEvents : ApplicationEventHandler
    {
        protected override void ApplicationStarted(UmbracoApplicationBase umbracoApplication, ApplicationContext applicationContext) {
            ...
            // CreateConfigFileForUCommerce()
            var configurationPath = umbracoApplication.Server.MapPath("~/Umbraco/ucommerce/Apps/" + companyName);
            var configurationReady = Directory.Exists(configurationPath);
            if (!configurationReady) {
                var configurationFolder = configurationPath + "/Configuration";
                var binFolder = configurationPath + "/bin";
                ...
                File.Copy(umbracoApplication.Server.MapPath("~/bin/" + fileName), binFolder + "/" + fileName);
            }

            // create paymentmethod inside ucommerce db table (I think)
            ...
            // creating fields for paymentMethod UI
            ...
            if (definitionfields != null)
            {
                ...
                // create paymentmethod inside ucommerce (I think)
